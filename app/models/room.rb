class Room < ApplicationRecord
  ...
  validates :address, length: { minimum: 10, maximum: 100, too_long: I18n.t('address.long', maxchar: 100), too_short: I18n.t('address.short', minchar: 10)}
  validates :price, :numericality => { :greater_than => 10, :less_than => 1000, :message=> I18n.t('price')}
